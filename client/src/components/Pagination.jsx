...
import logoPrev from '../design/icons/arrowLeft.png';
import logoNext from '../design/icons/arrowRight.png';
let style = require('../design/css/pagination.module.css');
                    ...
                    currentCards&&currentCards.map(e =>
                    {
                        return (
                            <div key={e.id}className={style.card}>
                                <Link to={`/yourCountry/detailCountry/${e.id}`}>
